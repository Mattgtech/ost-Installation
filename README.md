...
<p>
  <b>Step 2:<b/> Install the Installations files which are <a href = "https://drive.google.com/file/d/1RHsNd4eWIOwaNpj3JW4vzzmzNUH86wY_/view?usp=share_link">PHP Manager for IIS</a> and <a href = "https://drive.google.com/file/d/1tIK9GZBKj1JyUP87eewxgdNqn9pZmVmY/view?usp=share_link">Rewrite Module</a>. After Installing these files, the next step is to create a folder called "PHP" in "windowsc:" so that we can install PHP 7.3.8
</p>
<br />
