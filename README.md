...
<p>
<b>Step 2:<b/> Install the Installations files which are "PHP Manger for IIS"(https://drive.google.com/file/d/1RHsNd4eWIOwaNpj3JW4vzzmzNUH86wY_/view?usp=share_link) and Rewrite Module(https://drive.google.com/file/d/1tIK9GZBKj1JyUP87eewxgdNqn9pZmVmY/view?usp=share_link). After Installing these files, the next step is to create a folder called "PHP" in "windowsc:" so that we can install PHP 7.3.8
</p>
<br />
